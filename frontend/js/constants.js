const contractAddress = "0xC092810Caf05A1BEFD569F9596778C7485fD2C71"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Crypto Whalez";
const welcome_h2 = "Connect Wallet to Get Started";
const welcome_p = 'The CryptoWhalez is a simple collection of unique handracfted pixel artwork by a world renowed artist. Connect your wallet and start minting your pixel CryptoWhalez';
...
const p_presale_mint_already_minted = "You've already claimed your whitelisted mint. Thank you!";
const p_public_mint = "Public Miniting is available to everyone";
const button_presale_coming_soon = "Get Whitelisted";
